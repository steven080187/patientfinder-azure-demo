...
import { adminPatientBridgeRouter } from "./routes/adminPatientBridge.js";
import { adminWorkbooksRouter } from "./routes/adminWorkbooks.js";
import { patientBridgeM365Router } from "./routes/patientBridgeM365.js";
...
export function createApp() {
  ...
  app.use(adminPatientBridgeRouter);
  app.use(adminWorkbooksRouter);
  app.use(patientBridgeM365Router);
